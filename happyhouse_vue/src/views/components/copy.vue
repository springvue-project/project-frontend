  ...
  <div class="wrapper">
    <div id="javascriptComponents">
      ...
      <div class="title">
        ...
        <button @click="testdisplayMarker">test</button>
      </div>
      <div class="md-layout">
...
export default {
  ...
  mounted() {
    if (!window.kakao || !window.kakao.maps) {
      ...
      script.src = `//dapi.kakao.com/v2/maps/sdk.js?autoload=false&appkey=5bac587b1d037d39e5c1afb5a245aac9&autoload=false&libraries=services`;
      /* global kakao */
  ...
  methods: {
    ...
    testdisplayMarker() {
      console.log("testdisplayMarker");
      //1. 현재 표시되어 잇는 marker들이 있으면 markar에 등록된 map을 없애준다.
      ...
      // 4. 지도를 이동시켜 주기
      // const bounds = potisions.reduce(
      //   (bounds, position) => bounds.extend(position.latlng),
      //   new kakao.maps.LatLanBounds()
      // );
    },
